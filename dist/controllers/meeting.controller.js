...
class MeetingController {
    ...
    constructor() {
        ...
        this.logger = new logger_1.Logger("MeetingController");
    }
    createMeeting = async (req, res) => {
        try {
            ...
            res
                .status(201)
                .json(api_response_1.ApiResponse.success(meeting, "Meeting created successfully"));
        }
        catch (error) {
    ...
    getAllMeetings = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meetings, "Meetings retrieved successfully"));
        }
        catch (error) {
    ...
    getMeetingById = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meeting, "Meeting retrieved successfully"));
        }
        catch (error) {
            ...
            if (error.statusCode === 404) {
                res
                    .status(404)
                    .json(api_response_1.ApiResponse.error("Meeting not found", [], api_response_1.ResponseStatus.ERROR));
                return;
            }
            res
                .status(error.statusCode || 500)
    ...
    getUpcomingMeetings = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meetings, "Upcoming meetings retrieved successfully"));
        }
        catch (error) {
    ...
    updateMeeting = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meeting, "Meeting updated successfully"));
        }
        catch (error) {
    ...
    deleteMeeting = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(null, "Meeting deleted successfully"));
        }
        catch (error) {
    ...
    updateMeetingStatus = async (req, res) => {
        try {
            ...
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meeting, "Meeting status updated successfully"));
        }
        catch (error) {
    ...
    addExpectedAttendees = async (req, res) => {
        try {
            const { id } = req.params;
            ...
            const meeting = await this.meetingService.addExpectedAttendees(id, officerIds);
            res
                .status(200)
                .json(api_response_1.ApiResponse.success(meeting, "Expected attendees added successfully"));
        }
        catch (error) {
    ...
    createMonthlyMeeting = async (req, res) => {
        try {
            const { organizerId } = req.body;
            this.logger.info("Received create monthly meeting request", {
                organizerId,
            });
            const meeting = await this.meetingService.createMonthlyMeeting(organizerId);
            res
                .status(201)
                .json(api_response_1.ApiResponse.success(meeting, "Monthly meeting created successfully"));
        }
        catch (error) {
